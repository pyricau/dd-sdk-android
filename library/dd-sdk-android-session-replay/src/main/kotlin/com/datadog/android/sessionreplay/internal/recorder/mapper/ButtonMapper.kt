...
internal class ButtonMapper(
    ...
    override fun map(view: Button, mappingContext: MappingContext, delayedCallbackInfo: DelayedCallbackInfo?):
        List<MobileSegment.Wireframe.TextWireframe> {
        return textWireframeMapper.map(view, mappingContext, delayedCallbackInfo).map {
